          ...
          <div className='w-fit grid grid-cols-4 gap-9 mx-24 '>
            ...
            <div className='bg-white rounded-xl shadow-lg'>
              <div className='p-5 flex flex-col'>
                ...
                <a href='/dateplanner' className='border-b-4 border-r-4 text-center bg-pink-300 text-pink-700 py-2 rounded-lg font-semibold mt-6 hover:bg-pink-500 focus:scale-95 transition-all duration-200 ease-out'>Try it!</a>
              </div>
            </div>
            ...
            <div className='bg-white rounded-xl shadow-lg'>
              <div className='p-5 flex flex-col'>
                ...
                <a href='/journal' className='border-b-4 border-r-4 text-center bg-pink-300 text-pink-700 py-2 rounded-lg font-semibold mt-6 hover:bg-pink-500 focus:scale-95 transition-all duration-200 ease-out'>Take the Tendency Quiz</a>
              </div>
            </div>
